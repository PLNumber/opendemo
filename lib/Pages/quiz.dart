...
import 'package:opendemo/Function/class.dart';
  ...
  Future<void> _fetchQuestions() async {
    try {
      ...
      final questions = snapshot.docs
          .map<Question>((doc) => Question.fromMap(doc.data() as Map<String, dynamic>))
          .toList();
      setState(() {
...
class NotePage extends StatelessWidget {
  ...
  Future<List<Question>> _fetchWrongAnswers() async {
    final snapshot = await FirebaseFirestore.instance.collection('wrongAnswers').get();
      ...
      body: FutureBuilder<List<Question>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('저장된 오답이 없습니다.'));
          }
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                title: Text('문제: ${question.definition}'),
                subtitle: Text('정답: ${question.word}'),
              );
            },
          );
        },
